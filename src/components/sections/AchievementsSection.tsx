...
export const AchievementsSection = () => {
  return <section id="achievements" className="min-h-screen flex items-center justify-center px-6 py-20">
      <div className="max-w-6xl mx-auto w-full space-y-16">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          return <Card key={achievement.title} className="group p-8 bg-card/50 backdrop-blur-sm border-border hover:border-primary/30 transition-all duration-500 hover-lift animate-fade-in-up" style={{
