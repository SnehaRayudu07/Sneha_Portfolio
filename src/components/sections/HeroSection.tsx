...
export const HeroSection = () => {
  ...
  return <section id="home" className="min-h-screen flex items-center justify-center relative px-6 py-20">
      <div className="max-w-6xl mx-auto w-full">
        <div className="text-center space-y-8 animate-fade-in-up">
          ...
          <div className="space-y-4">
            <h1 className="text-6xl md:text-7xl font-bold leading-tight lg:text-5xl">
              Welcome to
              <br />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-8">
            <Button size="lg" onClick={scrollToContact} className="rounded-full bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <Mail className="mr-2 h-5 w-5" />
              Let's talk
            </Button>
            <Button size="lg" variant="outline" className="rounded-full border-primary/30 hover:bg-primary/10 transition-all duration-300">
              View Resume
