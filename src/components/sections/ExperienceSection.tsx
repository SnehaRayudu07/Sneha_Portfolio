...
const experiences = [
  {
    ...
    achievements: [
      "Built a couples' relationship app from scratch using Kotlin and Firebase",
      "Conducted 300+ user interviews to identify relationship pain points",
      "Designed, developed, and launched MVP on Play Store and App Store",
      "Onboarded 150+ alpha users for feedback and iteration",
    ],
  ...
  },
  {
    ...
    achievements: [
      "Started as a Google Solution Challenge project; later incubated at GITAM Venture Development Centre",
      "Led UI/UX and app development using Flutter and Firebase",
      "Integrated ML models to personalize user recommendations",
      "Top 200 Nationwide – Google Solution Challenge",
      "Winner – Startup Sprint Hackathon (₹10,000)",
      "Pitched to Northeastern University, Boston",
    ],
  ...
  },
  {
    ...
    achievements: [
      "Developed Kotlin-based automation system for 10,000+ user platform",
      "Implemented ML model achieving 85% extraction accuracy",
    ...
    <section id="experience" className="min-h-screen flex items-center justify-center px-6 py-20">
      <div className="max-w-6xl mx-auto w-full space-y-16">
        <div className="text-center space-y-4 animate-fade-in-up">
          <p className="text-sm text-primary uppercase tracking-wider">Curated Work</p>
            ...
            >
              <div className="grid md:grid-cols-[200px_1fr] gap-8">
                ...
                <div className="space-y-6">
                  ...
                  {exp.hasVideo && (
                    <div className="relative aspect-[9/16] max-w-[200px] bg-muted rounded-xl overflow-hidden border border-border">
                ...
                <div className="space-y-6">
                  ...
                  {exp.hasVideo && (
                    <button className="inline-flex items-center gap-2 text-primary hover:text-primary/80 transition-colors group/btn">
